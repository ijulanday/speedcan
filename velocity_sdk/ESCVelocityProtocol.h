 ...
 * The protocol enumeration for this version is: 61
 * 
 * The protocol version is 3.40
 */
...
#define getESCVelocityApi() 61

//! \return the protocol version string
#define getESCVelocityVersion() "3.40"
...
typedef enum
{
    ...
    CMD_ESC_LOCK_SETTINGS,               //!< Lock ESC nonvolatile settings
